...
export type ProductItemFragment = {
  ...
  variants: Array<{ __typename?: 'ProductVariant'; id: string; name: string; price: any }>
}
...
export function useGetOrderSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<GetOrderQuery, GetOrderQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useAddItemToOrderMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<AddItemToOrderMutation, AddItemToOrderMutationVariables>(
